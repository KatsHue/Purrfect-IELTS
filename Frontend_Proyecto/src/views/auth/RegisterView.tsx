...
export default function RegisterView() {
  ...
  return (
    <>
      <h1 className="text-5xl font-black text-[#442e14]">Crear Cuenta</h1>
      ...
      >
        ...
        <div className="flex flex-col gap-5">
          <label className="font-normal text-2xl text-[#442e14]">Nombre</label>
          <input
            type="name"
        ...
        <div className="flex flex-col gap-5">
          <label className="font-normal text-2xl text-[#442e14]">
            Password
          </label>
        ...
        <input
          type="submit"
          value="Registrarme"
          className="bg-[#f4bc3c] hover:bg-[#e9b02f] w-full p-3  text-[#442e14] font-black  text-xl cursor-pointer rounded-md"
        />
      </form>
